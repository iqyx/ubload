 ...
 */
extern struct pubkey_storage_slot pubkey_storage_slots[PUBKEY_STORAGE_SLOT_COUNT];

/**
 * Public key hashes are salted with a value set at first boot.
 */
extern uint8_t pubkey_storage_salt[PUBKEY_STORAGE_SALT_SIZE];
